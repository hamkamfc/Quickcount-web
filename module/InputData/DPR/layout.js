...
function JxInputData_DPR ()
{
	this.id		= "InputData_DPR";
	...
	this.sHasil		= Ext.create ("Jx.Store", {
		url			:Jx.generateModDir ("InputData_DPR")
	,	singleApi	:false
	,	remoteFilter:true
	...
	this.sRekap		= Ext.create ("Jx.Store", {
		url			:Jx.generateModDir ("InputData_RekapDPR")
	,	singleApi	:false
	,	remoteFilter:true
	,	fields		:
		[
...
var InputData_DPR = new JxInputData_DPR();
